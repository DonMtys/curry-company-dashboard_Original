...
with st.sidebar:
    ...
    # Para deploy na nuvem, usar links relativos
    st.markdown("""
    <div style="margin-bottom: 1rem;">
        <a href="/Visão_empresa_simples" target="_blank" style="text-decoration: none;">
    ...
    <div style="margin-bottom: 1rem;">
        <a href="/Visão_Entregadores" target="_blank" style="text-decoration: none;">
    ...
    <div style="margin-bottom: 1rem;">
        <a href="/Visão_Restaurantes" target="_blank" style="text-decoration: none;">
...
with col1:
    with st.container():
        ...
        # Botão estilizado
        if st.button("🚀 ENTRAR AGORA - EMPRESA", use_container_width=True):
            st.switch_page("pages/Visão_empresa_simples.py")
...
with col2:
    with st.container():
        ...
        # Botão estilizado
        if st.button("🚀 ENTRAR AGORA - ENTREGADORES", use_container_width=True):
            st.switch_page("pages/Visão_Entregadores.py")
...
with col3:
    with st.container():
        ...
        # Botão estilizado
        if st.button("🚀 ENTRAR AGORA - RESTAURANTES", use_container_width=True):
            st.switch_page("pages/Visão_Restaurantes.py")
...
with col1:
    ...
    - 🖱️ **Clique nos botões** para navegar diretamente
    - 🔄 **Navegação entre páginas** 
    - 📱 **Compatível** com desktop e mobile
    - 🏠 **Sempre volte** para esta página Home
    """)
